    ...
    <footer className="border-t border-border bg-surface">
      <div className="mx-auto max-w-6xl px-5">
        <div className="grid gap-8 py-12 sm:grid-cols-3">
          ...
          <div>
            <LogoFull />
            <p className="mt-2 text-sm text-foreground-secondary leading-relaxed max-w-xs">
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-[10px] font-medium tracking-[0.15em] text-foreground-muted uppercase mb-3">
              Explore
            </h4>
          ...
          <div>
            ...
            <div className="flex gap-6 mb-4">
              <div>
                ...
                <p className="text-[10px] text-foreground-muted font-mono tracking-[0.1em] uppercase">
                  Concepts
                </p>
              </div>
              <div>
